...
function ProjectDetailPanel({ project, donors, users, onClose, onDelete, onAssignTeam, onEdit }) {
  ...
  return (
    <>
      ...
      />
      {/* Panel */}
      <div className="fixed inset-y-0 right-0 z-50 flex flex-col w-full sm:max-w-xl md:max-w-2xl lg:max-w-3xl xl:max-w-4xl bg-white shadow-2xl border-l border-slate-200">
        {/* Header */}
