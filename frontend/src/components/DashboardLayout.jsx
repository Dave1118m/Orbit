  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-100 font-sans">
      ...
      <div className="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
        ...
        {/* Top Header */}
        <header className="sticky top-0 z-20 flex h-16 sm:h-20 flex-shrink-0 items-center justify-between border-b border-slate-200 bg-white px-3 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 sm:gap-4 lg:hidden">
            ...
            <div className="flex items-center gap-2">
              <img src="/logo.png" alt="OrbitDesk Logo" className="w-7 h-7 sm:w-8 sm:h-8 object-contain drop-shadow-sm" />
              <span className="font-bold text-slate-900 text-sm sm:text-base">OrbitDesk</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 lg:hidden">
            ...
            <button 
              ...
              className="relative rounded-full border border-slate-200 bg-white p-2 text-slate-500 hover:text-slate-700 transition shadow-xs"
              title="Notifications"
            >
            ...
            <button
              ...
              className="h-8 w-8 overflow-hidden rounded-full bg-slate-800 text-xs font-bold text-white shadow-xs"
            >
              {user?.photoUrl ? (
                <img src={getPhotoSrc(user.photoUrl)} alt={user.name} className="h-full w-full object-cover" />
              ) : (
                <span className="flex h-full w-full items-center justify-center bg-slate-800 text-xs text-white">
                  {userInitials}
                </span>
              )}
            </button>
